...
import { Lead, ActivityItem, AppView } from '../../types';
          ...
          <div className="bg-[#1b2b48] text-white p-6 rounded-xl border border-[#4f5e7e] space-y-4">
            ...
            {leads[0] && (
              <div>
                ...
                <button
                  onClick={() => onSelectLead(leads[0])}
                  className="w-full bg-[#ffdeac] text-[#281900] py-2.5 rounded-lg font-mono-data text-xs uppercase font-bold tracking-wider hover:bg-[#fddba7] transition-colors cursor-pointer"
                >
