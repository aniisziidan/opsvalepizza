      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 md:px-16 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-[#1b2b48]">
          ...
          <div className="md:col-span-6 lg:col-span-5">
            <button
              ...
              className="font-headline text-2xl font-bold text-white flex items-center gap-2 mb-4 hover:opacity-90 transition-opacity cursor-pointer text-left"
            >
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-mono-data text-[#8393b5]">
          ...
          <div className="flex gap-6">
            ...
            <a href="#terms" onClick={(e) => e.preventDefault()} className="hover:text-white">Terms of Supply</a>
            <a href="#iso" onClick={(e) => e.preventDefault()} className="hover:text-white">FSC / ISO 9001</a>
          </div>
        </div>
      </div>
    </footer>
